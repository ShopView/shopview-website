...
@section('content')
    ...
    <main>
        <x-product-hero
            seed="features/vin-decoder"
            title="VIN Decoder Built for Heavy-Duty Repair Shops"
            description="Decode heavy trucks, trailers, and equipment instantly. ShopView's VIN Decoder integration pulls verified vehicle data directly into work orders, estimates, and service records - no manual entry, no missed details, no downtime."
            primary-href="/trial"
            ...
            <div class="container">
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        ...
                        <div class="bg-white/5 border border-white/10 rounded-xl p-6">
                            <div class="w-10 h-10 flex items-center justify-center mb-4">
                                <x-lucide-truck class="w-8 h-8 text-[#247CFF]" />
                            </div>
            ...
            <div class="container">
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        ...
                        <div class="bg-white/5 border border-white/10 rounded-xl p-6">
                            <div class="w-10 h-10 flex items-center justify-center mb-4">
                                <x-lucide-history class="w-8 h-8 text-[#247CFF]" />
                            </div>
