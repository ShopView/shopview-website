...
@section('content')
    ...
    <main>
        <x-product-hero
            seed="features/technician-time-tracking"
            title="Technician Time Clock That Boosts Billable Hours"
            description="Never miss another minute of tech time. Increase your tech billable hours by up to 2 hours per day, per tech!"
            primary-href="/trial"
