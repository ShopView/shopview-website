...
@section('content')
    ...
    <main>
        <x-product-hero
            seed="features/scheduling"
            title="Simplified Scheduling That Keeps Your Heavy-Duty Shop on Track"
            description="Easily assign jobs, balance workloads, and prevent scheduling conflicts. ShopView's repair scheduling software gives you complete visibility into every technician, bay, and work order - so your heavy-duty repair shop runs smoother, every hour of the day."
            primary-href="/trial"
