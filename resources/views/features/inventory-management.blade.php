...
@section('content')
    ...
    <main>
        <x-product-hero
            seed="features/inventory-management"
            title="Parts Inventory Made Simple, Accurate, and Profitable"
            description="ShopView's repair shop inventory management software keeps your inventory lean, accurate, and ready for every job that rolls in - whether you're running a diesel, fleet, or heavy-duty repair shop."
            primary-href="/trial"
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="rounded-xl overflow-hidden">
                            <img src="{{ asset('images/screenshots/Inventory & New inventory part.png') }}" alt="ShopView Inventory Management" class="w-full h-auto rounded-xl">
                        </div>
                    </div>
                </div>
            </div>
