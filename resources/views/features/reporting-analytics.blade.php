...
@section('content')
    ...
    <main>
        <x-product-hero
            seed="features/reporting-analytics"
            title="Reporting & Analytics That Drive More Profit"
            description="ShopView's repair shop reporting software turns your day-to-day operations into actionable insights - so you can make smarter decisions, faster."
            primary-href="/trial"
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="rounded-xl overflow-hidden">
                            <img src="{{ asset('images/screenshots/Growth Over Time.png') }}" alt="ShopView Analytics Dashboard" class="w-full h-auto rounded-xl">
                        </div>
                    </div>
                </div>
            </div>
