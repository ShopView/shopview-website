                ...
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        <div class="bg-white/5 border border-white/10 rounded-xl p-8">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center mb-6">
            ...
            <div class="container">
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="tel:+15874389423" class="btn btn-secondary items-center justify-center gap-2" style="display: inline-flex;">
                            <x-dynamic-component component="lucide-phone" class="w-5 h-5 mr-2" />
                            <span>+1-587-438-9423</span>
                        </a>
                        <a href="mailto:hello@shopview.com" class="btn btn-secondary items-center justify-center gap-2" style="display: inline-flex;">
                            <x-dynamic-component component="lucide-mail" class="w-5 h-5 mr-2" />
                            <span>hello@shopview.com</span>
                        </a>
                    </div>
                </div>
            </div>
