...
@section('content')
    ...
    <main>
        <x-product-hero
            seed="integrations/shopcoach"
            title="Heavy-Duty Shop AI That Makes Managing Effortless"
            description="Make better and faster decisions about every aspect of your heavy-duty repair shop with AI. It's like having a team of service managers, without the cost or headcount."
            primary-href="/trial"
